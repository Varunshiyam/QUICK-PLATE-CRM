 ...
 const handleSaveNewAddress = () => {
  ...
  const filteredRestaurants = useMemo(() => {
    ...
    if (activePriceFilters.length > 0) {
      result = result.filter(r => activePriceFilters.includes(r.price));
    }
    ...
    return result;
  }, [restaurants, searchQuery, activeCategory, activeSort, activePriceFilters]);
  ...
  return (
    <div className="home-page">
      ...
      <header className="home-header">
        ...
        {/* ΓöÇΓöÇΓöÇ Header Dropdowns ΓöÇΓöÇΓöÇ */}
        <AnimatePresence>
          {isAddressModalOpen && (
            <motion.div
          ...
          {/* ΓöÇΓöÇΓöÇ Add New Address Form Modal ΓöÇΓöÇΓöÇ */}
      ...
      <main>
        {/* ΓöÇΓöÇΓöÇ Hero Carousel Banner ΓöÇΓöÇΓöÇ */}
        <motion.section
        ...
        {/* ΓöÇΓöÇΓöÇ Categories ΓöÇΓöÇΓöÇ */}
        <motion.section
        ...
        {/* ΓöÇΓöÇΓöÇ Trending Now ΓöÇΓöÇΓöÇ */}
        <motion.section
        ...
        {/* ΓöÇΓöÇΓöÇ Premium Selections ΓöÇΓöÇΓöÇ */}
        <motion.section
        ...
        {/* ΓöÇΓöÇΓöÇ Smart Protection ΓöÇΓöÇΓöÇ */}
        <motion.section
      ...
      {/* ΓöÇΓöÇΓöÇ Bottom Navigation ΓöÇΓöÇΓöÇ */}
      ...
      {/* ΓöÇΓöÇΓöÇ Filter Bottom Sheet Modal ΓöÇΓöÇΓöÇ */}
      <AnimatePresence>
        {isFilterOpen && (
          <>
            <motion.div 
            ...
            >
              ...
              <div className="filter-section">
                ...
                <div className="filter-chips">
                  {['$', '$$', '$$$', '$$$$'].map(price => (
                    <button
                      key={price}
                      className={`filter-chip ${activePriceFilters.includes(price) ? 'active' : ''}`}
                      onClick={() => {
                        lightTap();
              ...
              {activePriceFilters.length > 0 && (
                <div className="filter-section" style={{ border: 'none', paddingTop: 0 }}>
                  <button
                    className="filter-clear-btn"
                    onClick={() => { lightTap(); setActivePriceFilters([]); }}
                  >
                    Clear price filters
                  </button>
                </div>
